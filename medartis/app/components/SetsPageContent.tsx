// app/components/SetsPageContent.tsx
'use client';

import { useState, useEffect, Suspense } from 'react';
import { useSearchParams } from 'next/navigation';
import SetInventoryCard from './SetInventoryCard';
import SetDetailsDrawer from './SetDetailsDrawer';
import { fetchEnrichedSets } from '../actions/getSetsAction';
import type { VirtualSet } from '../types/interfaces'; // Ensure this matches your unified server file
